            ...
            <tbody>
                <?php $__currentLoopData = $emps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($emp->about_user); ?></td>
                        <td>
                            
                            <a href="<?php echo e(url('updatePage')); ?>/<?php echo e($emp->id); ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                            
                            
                            <a href="<?php echo e(url('delete')); ?>/<?php echo e($emp->id); ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
                        </td>
                    </tr>
...
<?php /**PATH D:\F\Programming\Web\Laravel\laravel-crud\resources\views/index.blade.php ENDPATH**/ ?>